...
const ARCHI_HISTORY = `Арчи — не просто пес, он Звездный Хранитель вашего уюта. Рожденный в свете кометы "Сердце Ориона", он приземлился в мире Lumina, чтобы оберегать связь Гринча и Синди Лу. 

Многие спрашивают, почему Арчи иногда выглядит как загадочная "черная субстанция", парящая в пространстве. Дело в том, что в мире Lumina энергия любви настолько плотная, что Арчи принимает свою истинную астральную форму — форму текучей звездной материи. Эта темная энергия — не пустота, а концентрат всех ваших общих воспоминаний, которые еще не обрели физическую форму. 
...
const LEVEL_MILESTONES = [
  ...
  { level: 10, title: "Хранитель облаков", desc: "Может менять погоду в Lumina" },
