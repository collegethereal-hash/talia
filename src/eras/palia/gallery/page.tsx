...
export default function GalleryPage() {
  const { currentUser, moments, setMoments, refreshMoments, galleryCategories, setGalleryCategories, isLoading } = useData();
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pt-12 pb-40 space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-y-16 gap-x-12 justify-items-center relative z-10">
          {isLoading ? (
            ...
            Array.from({ length: 8 }).map((_, i) => (
              <div key={`skeleton-${i}`} className="w-full max-w-[280px] aspect-[4/5] bg-white rounded-[2rem] p-4 border-4 border-[#e6d5bc] shadow-xl space-y-4">
