...
const FORTUNES = [
  "Сегодня ваш день будет наполнен светом и магией. Ожидайте неожиданную радость. ✨",
  "Ваша улыбка скоро осветит чей-то день. Не забывайте делиться ей с миром. 🌸",
  "Вселенная приготовила для вас нечто особенное. Откройте свое сердце. 🌠",
  "Даже самые маленькие шаги ведут к великим свершениям. Продолжайте идти вперед. 🦋",
  "Вам суждено встретить чудо в самых обычных вещах сегодня. Оглянитесь вокруг! 🌿",
];
