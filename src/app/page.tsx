...
const FORTUNES = [
  "Твой челендж: отправь партнеру голосовое сообщение с песней, которую ты сейчас напеваешь! 🎤",
  "Магия дня: сделай скриншот чего-то смешного или красивого и отправь в Журнал с тегом #улыбка. 📸",
  "Вызов Talia: вспомни самое первое свидание и напиши об одном моменте, который ты никогда не забудешь. 📖",
  "Романтическое задание: отправь партнеру фото своего завтрака/обеда прямо сейчас! 🍕",
  "Звездное предсказание: сегодня отличный день, чтобы запланировать ваше следующее свидание. ✈️",
  "Тайное задание: напиши 'Я тебя люблю' на 3 разных языках в вашем чате! ✨",
  "Момент нежности: расскажи партнеру, какая черта его характера восхищает тебя больше всего сегодня. 🌸",
];

const INTERESTING_FACTS = [
  "Кошки спят в среднем 12-16 часов в день, что составляет около 70% их жизни 🐾",
  "Пчелы способны распознавать человеческие лица и запоминать их 🐝",
  "Сердце креветки находится в ее голове 🦐",
  "Самая высокая гора в Солнечной системе находится на Марсе — это вулкан Олимп высотой 21 км 🌋",
  "Муравьи никогда не спят, они лишь снижают свою активность 🐜",
];

const BOTTLE_MESSAGES = [
  "Привет! Пусть этот день принесет тебе только улыбки и тепло. Ты справишься со всем! 💖",
  "Не забывай отдыхать и заботиться о себе. Ты — самое ценное, что у тебя есть. 🌸",
  "Каждая твоя мечта имеет значение. Верь в себя так же сильно, как мы верим в тебя! ✨",
  "Этот океан принес тебе весточку: ты невероятный человек, и мир становится лучше благодаря тебе. 🌊",
  "Даже если сегодня пасмурно, помни, что солнце всегда светит за облаками. Улыбнись! ☀️",
];
