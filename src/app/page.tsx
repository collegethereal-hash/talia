  ...
  const categories = [
    {
      ...
      items: [
        ...
        { q: "Почему Арчи парит?", a: "В мире Lumina Арчи — звездное существо. Он принимает астральную форму, чтобы лучше чувствовать ваши мысли и связь." }
      ]
    },
    {
      ...
      items: [
        ...
        { q: "Что за кнопка 'Вспомнить'?", a: "Это магия Lumina! Она выбирает случайное фото из вашего архива, чтобы напомнить о теплом моменте." }
      ]
    },
    {
      title: "✨ Магические Механики",
      items: [
        { q: "Послание в бутылке", a: "Каждый день в океан Lumina приплывает новая записка. Это короткие послания, которые живут всего 24 часа." },
          ...
          >
            ...
            <div className="p-8 md:p-12 bg-[#f5e6d3] border-b-4 border-[#e6d5bc] relative shrink-0">
              ...
              <div className="space-y-2">
                ...
                <h2 className="text-4xl md:text-6xl font-serif font-bold text-[#5c4a33] tracking-tight">Библиотека Lumina</h2>
